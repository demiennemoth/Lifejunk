...
const actions = [
  ...
  },
  {
    ...
    apply() {
      ...
      d("Рамэн. Солёная химия, но душа теплее. Сытость на 6 часов.");
    },
  },
  {
    key: "shower",
    ...
    apply() {
      ...
      d("Душ. Мир стал на 10% терпимее.");
    },
  },
  {
    key: "walk",
    name: "Гулять в наушниках (1ч)",
    dur: 1,
    apply() {
      mod({ mood: +12, social: +2, energy: -6 });
      d("Прогулка. Дома не стало меньше, но воздуха больше.");
    },
  },
  {
    key: "train",
    ...
    apply() {
      ...
      d("Железо постонало, но уважает тебя.");
    },
  },
  {
    key: "create",
    ...
    apply() {
      ...
      d("Творчество. Что-то получилось, даже если это шум.");
    },
  },
  {
    key: "freelance",
    ...
    apply() {
      ...
      d(`Фриланс. Продал(а) 2 часа жизни за ${cash}₽.`);
    },
  },
  {
    key: "doom",
    name: "Залип в сети (1ч)",
    dur: 1,
    apply() {
      ...
      d(
        swing > 0
          ? "Интернет. Нашёл(ла) мем и смысл на 15 минут."
          : "Интернет. Ещё одна дырка в внимании."
      );
      chanceEvent();
    },
  },
